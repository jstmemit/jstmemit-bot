...
export const locale: Record<string, LocalizationMap> = {
    ...
    "settings.font.comicSans.description": buildLocales("Casual, hand-lettered font (default)", {
        [Locale.Russian]: "Неформальный шрифт, будто написан от руки (по умолчанию)",
        [Locale.Ukrainian]: "Неформальний шрифт, ніби написаний від руки (за замовчуванням)",
        [Locale.Dutch]: "Informeel lettertype, alsof het met de hand geschreven is (standaard)",
        [Locale.French]: "Police décontractée, façon écriture à la main (par défaut)",
        [Locale.German]: "Lockere Schriftart, wie handgeschrieben (Standard)",
        [Locale.Polish]: "Nieformalna czcionka, jakby pisana ręcznie (domyślna)",
        [Locale.SpanishES]: "Fuente informal, como escrita a mano (predeterminada)",
        [Locale.SpanishLATAM]: "Fuente informal, como escrita a mano (predeterminada)",
        [Locale.PortugueseBR]: "Fonte informal, parecendo escrita à mão (padrão)",
        [Locale.Turkish]: "Elle yazılmış gibi duran samimi bir yazı tipi (varsayılan)",
        [Locale.Italian]: "Font informale, come scritto a mano (predefinito)",
        [Locale.Indonesian]: "Font santai, seperti tulisan tangan (default)",
        [Locale.Czech]: "Neformální písmo, jako psané rukou (výchozí)",
    }),
